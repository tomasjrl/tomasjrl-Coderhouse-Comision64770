...
export function buscarProductos() {
  ...
  // busca en cada carta de producto si los parámetros coinciden o no
  ...
  productosElementos.forEach((productoElemento) => {
    ...
    if (
      ...
      // pasa todo a minúscula para hacer la comparación entre lo escrito por el usuario y los productos
